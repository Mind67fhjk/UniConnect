...
const styles = StyleSheet.create({
  ...
  menuTitle: { color: 'white', fontSize: 16, fontWeight: '900' },
  menuRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  menuItem: {
    width: '30%',
    minWidth: 110,
    padding: 12,
  ...
  menuLabel: { color: 'white', fontWeight: '800', fontSize: 13, textAlign: 'center' },
  bottomNav: {
    position: 'absolute',
    left: 0,
    right: 0,
