...
const features = [
  {
    ...
    desc: "Access and share lecture notes, exam papers, and materials.",
    icon: "book-outline",
  },
  {
    id: 2,
    title: "Campus Forums",
    desc: "Join discussions specific to your field of study.",
    icon: "chatbubbles-outline",
  },
  {
    id: 3,
    title: "Event Calendar",
    desc: "Stay informed about academic calendars and campus events.",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.heroSection}>
          <Image
            source={{
              uri: "https://images.unsplash.com/photo-1523240693567-d92e8a9990eb?q=80&w=2070&auto=format&fit=crop",
            }}
            style={styles.heroImage}
          />
          <Text style={styles.heroTitle}>Uniting Students Across Ethiopia</Text>
          <Text style={styles.heroSubtitle}>
            The premier digital hub for sharing resources, connecting with
            peers, and staying updated.
          </Text>
        </View>
        ...
        <View style={styles.featuresSection}>
          ...
          <Text style={styles.sectionSubtitle}>
            We've built a platform specifically designed for the Ethiopian
            higher education ecosystem.
          </Text>

          {/* እያንዳንዱን ዳታ ወደ ካርድ የምንቀይርበት ቦታ (Mapping) */}
          {features.map((item) => (
...
const styles = StyleSheet.create({
  ...
  featureCard: {
    flexDirection: 'row',
    backgroundColor: '#1c242e', // ካርዱ ከዳራው ትንሽ ጎላ እንዲል
    padding: 15,
    borderRadius: 12,
    marginBottom: 15,
    borderWidth: 1,
  ...
  featureIconBox: {
    backgroundColor: 'rgba(19, 127, 236, 0.1)', // ደብዛዛ ሰማያዊ
    padding: 12,
    borderRadius: 10,
  },
  featureTextContent: {
    flex: 1, // ጽሁፉ የቀረውን ቦታ እንዲይዝ
  },
  featureTitle: {
    color: 'white',
    fontSize: 18,
